...
//"640x400" 31.50     640 672 736 832 400 401 404 445
//"720x400" 35.50     720 756 828 936 400 401 404 446
...
//"720x576" 27.00    1440 1464 1590 1728 576 580 586 624
	VIDEOMODE(const int h, const int v) {
		m_err = false;
		if ((h == 640)&&(v == 400)) {
			setline(m_h, "640 672 736 832");
			setline(m_v, "400 401 404 445");
		} else if ((h==640)&&(v==480)) {
			// 640 664 736 760 480 482 488 525
			setline(m_h, "640 656 752 800");
			setline(m_v, "480 490 492 521");
		} else if ((h==720)&&(v == 400)) {
			setline(m_h, "720 756 828 936");
			setline(m_v, "400 401 404 446");
		} else if ((h==720)&&(v == 480)) {
